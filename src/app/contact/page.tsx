...
import { MapPin, Phone, Mail, Send, CheckCircle, AlertCircle, Clock, Users, Award, Shield } from "lucide-react"
        ...
        <Card className="max-w-md w-full text-center shadow-2xl border-0 bg-white">
          <CardContent className="p-12 space-y-6">
            ...
            <div className="space-y-3">
              <h2 className="text-3xl font-bold text-[#3A5A40]">Message Sent Successfully!</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="text-center lg:text-left">
                <h2 className="text-4xl lg:text-5xl font-bold text-[#3A5A40] mb-4">Let's Start a Conversation</h2>
                <p className="text-xl text-gray-600 max-w-2xl">
                  Fill out the form below with your project details, and we'll get back to you with a personalized
                  solution.
                </p>
              </div>
              ...
              <Card className="shadow-2xl border-0 bg-white overflow-hidden pt-0">
                <CardHeader className="bg-gradient-to-r from-[#3A5A40]/5 to-[#AE8F65]/5 p-8">
                  <CardTitle className="text-2xl text-[#3A5A40] text-center">Send Us a Message</CardTitle>
                </CardHeader>
                <CardContent className="p-8 lg:p-12">
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        ...
                        <Input
                          ...
                          className={`h-14 text-lg ${errors.firstName ? "border-red-500 focus:border-red-500" : "border-gray-200 focus:border-[#3A5A40]"} transition-all duration-200`}
                          placeholder="John"
                        />
                        {errors.firstName && (
                      ...
                      <div className="space-y-3">
                        <Label htmlFor="lastName" className="text-sm font-semibold text-[#3A5A40]">
                          Last Name *
                        </Label>
                        <Input
                          id="lastName"
                          ...
                          className={`h-14 text-lg ${errors.lastName ? "border-red-500 focus:border-red-500" : "border-gray-200 focus:border-[#3A5A40]"} transition-all duration-200`}
                          placeholder="Doe"
                        />
                        {errors.lastName && (
                          <div className="flex items-center gap-2 text-red-600 text-sm">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                      <div className="space-y-3">
                        <Label htmlFor="email" className="text-sm font-semibold text-[#3A5A40]">
                          Email Address *
                        </Label>
                        <Input
                          id="email"
                          ...
                          className={`h-14 text-lg ${errors.email ? "border-red-500 focus:border-red-500" : "border-gray-200 focus:border-[#3A5A40]"} transition-all duration-200`}
                      ...
                      <div className="space-y-3">
                        <Label htmlFor="phone" className="text-sm font-semibold text-[#3A5A40]">
                          Phone Number *
                        </Label>
                        <Input
                          id="phone"
                          ...
                          className={`h-14 text-lg ${errors.phone ? "border-red-500 focus:border-red-500" : "border-gray-200 focus:border-[#3A5A40]"} transition-all duration-200`}
                    ...
                    {/* Message Field */}
                    <div className="space-y-3">
                      <Label htmlFor="message" className="text-sm font-semibold text-[#3A5A40]">
                        Project Details *
                      </Label>
                      <Textarea
                        id="message"
                        ...
                        className={`min-h-40 text-lg resize-none ${errors.message ? "border-red-500 focus:border-red-500" : "border-gray-200 focus:border-[#3A5A40]"} transition-all duration-200`}
                      ...
                      <div className="flex justify-between items-center">
                        {errors.message ? (
                          ...
                          <div className="text-sm text-gray-500">Minimum 10 characters required</div>
                        )}
            ...
            <div className="space-y-8">
              ...
              <Card className="shadow-2xl border-0 bg-white overflow-hidden py-0">
                <CardHeader className="bg-gradient-to-r from-[#AE8F65]/10 to-[#AE8F65]/5 p-6">
                  <CardTitle className="text-2xl text-[#3A5A40]">Contact Information</CardTitle>
                </CardHeader>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-1">
                        <h4 className="font-semibold text-[#3A5A40] text-lg">Email Address</h4>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-1">
                        <h4 className="font-semibold text-[#3A5A40] text-lg">Phone Number</h4>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-1">
                        <h4 className="font-semibold text-[#3A5A40] text-lg">Office Address</h4>
                ...
                <CardContent className="p-8 pt-0">
                  <div className="space-y-4">
                    <div className="flex justify-between items-center py-2">
                      ...
                      <Badge className="bg-[#AE8F65] text-white border-0">9:00 AM - 6:00 PM</Badge>
                    </div>
                    <div className="flex justify-between items-center py-2">
                      <span className="text-white/80">Saturday</span>
                      <Badge className="bg-[#AE8F65]/80 text-white border-0">10:00 AM - 4:00 PM</Badge>
                    </div>
                    <div className="flex justify-between items-center py-2">
                  ...
                  <div className="text-center">
                    <p className="text-white/80 text-sm">Need urgent assistance?</p>
                    <p className="text-[#AE8F65] font-semibold">Call us for emergency support</p>
                  </div>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#3A5A40]/5 to-[#AE8F65]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-4xl font-bold text-[#3A5A40] mb-4">Find Our Office</h3>
          ...
          <Card className="shadow-2xl border-0 bg-whit overflow-hidden py-0">
            <CardContent className="p-0">
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3500.562977189838!2d77.12609107529067!3d28.672801375642848!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d031290a1aa77%3A0x444d63f308de1f5b!2sKevasiya!5e0!3m2!1sen!2sin!4v1750769709987!5m2!1sen!2sin" width="600" height="450"loading="lazy" className="w-full h-full absolute top-0 left-0 -z-1"></iframe>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center space-y-6">
                    ...
                    <div className="space-y-3">
                      <h4 className="text-2xl font-bold text-[#3A5A40]">Interactive Map</h4>
                      <p className="text-gray-600 max-w-md mx-auto">
                        Click below to view our exact location and get directions via Google Maps
                      </p>
                    </div>
                    <a href="https://maps.app.goo.gl/KvrAG625XLWk3eCC9" target="_blank">
                    <Button
                      size="lg"
          ...
          <div className="text-center space-y-12">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Button
                ...
                onClick={() => window.open("https://www.facebook.com/kevasiya", "_blank")}
              >
                Facebook
              </Button>
              {/* <Button
              ...
              <Button
                ...
                variant="outline"
                className="bg-white/10 border-[#AE8F65]/50 text-white hover:bg-[#AE8F65]/20 hover:border-[#AE8F65] transition-all duration-300 px-8 py-4 text-lg hover:cursor-pointer"
                onClick={() => window.open("https://www.instagram.com/kevasiya.in/", "_blank")}
              >
                Instagram
              </Button>
            </div>
